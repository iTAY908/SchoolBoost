...
export const HELP = [
  ...
  '/reset — איפוס זיכרון השיחה עם ה-AI',
  '/help — העזרה הזו',
  '',
  ...
  '',
  '<b>שיחה חופשית</b>',
  'אם הופעל מוח AI, אפשר פשוט לדבר איתי:',
  '• <code>מה יש לי מחר?</code>',
  '• <code>תכין לי מצגת על מלחמת העולם השנייה</code>',
  '• <code>מה הממוצע שלי במתמטיקה?</code>',
  '',
  '<b>פורמט תאריכים</b>',
