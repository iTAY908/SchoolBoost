...
export default function AboutSection() {
  return (
    ...
    >
      ...
      >
        <img src={`${BASE}/moon_icon.11395d36.png`} alt="" className="h-auto w-full" />
      </FadeIn>
      ...
      >
        <img src={`${BASE}/p59_1.4659672e.png`} alt="" className="h-auto w-full" />
      </FadeIn>
      ...
      >
        <img src={`${BASE}/lego_icon-1.703bb594.png`} alt="" className="h-auto w-full" />
      </FadeIn>
      ...
      >
        <img src={`${BASE}/Group_134-1.2e04f3ce.png`} alt="" className="h-auto w-full" />
      </FadeIn>
